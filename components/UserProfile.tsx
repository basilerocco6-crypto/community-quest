      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Text size="2" color="gray" className="text-gray-400">Level {user.currentLevel}</Text>
            <Text size="1" color="gray" className="text-gray-500">{pointsToNextLevel} points to level up</Text>
          </div>
        </div>
