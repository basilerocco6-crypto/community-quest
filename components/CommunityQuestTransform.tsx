...
export default function CommunityQuestTransform() {
  ...
  // Force desktop layout with CSS transforms and direct DOM manipulation
  useEffect(() => {
    if (typeof window === 'undefined') return;

    const forceDesktopLayout = () => {
      // Create and inject CSS that cannot be overridden
      ...
      // Force layout with direct DOM manipulation
      const container = document.querySelector('.whop-main-container') as HTMLElement;
      if (container) {
      ...
      const profile = document.querySelector('.whop-profile-section') as HTMLElement;
      if (profile) {
        profile.style.setProperty('width', '33.333333%', 'important');
        ...
        profile.style.setProperty('gap', '1rem', 'important');
        profile.style.setProperty('padding', '1rem', 'important');
        profile.style.setProperty('box-sizing', 'border-box', 'important');
      }

      const levels = document.querySelector('.whop-levels-section') as HTMLElement;
      if (levels) {
        levels.style.setProperty('width', '66.666667%', 'important');
        ...
        levels.style.setProperty('gap', '2rem', 'important');
        levels.style.setProperty('padding', '1rem', 'important');
        levels.style.setProperty('box-sizing', 'border-box', 'important');
      }

      const leftCol = document.querySelector('.whop-levels-left') as HTMLElement;
      if (leftCol) {
      ...
      const rightCol = document.querySelector('.whop-levels-right') as HTMLElement;
      if (rightCol) {
    ...
    const interval = setInterval(forceDesktopLayout, 100);
    
    // Also watch for DOM changes
    const observer = new MutationObserver(forceDesktopLayout);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Main Content with FORCED DESKTOP LAYOUT */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="space-y-6 sm:space-y-8">
          <div className="bg-card rounded-lg p-4 sm:p-6 shadow-lg border border-border">
            {/* FORCED DESKTOP LAYOUT CONTAINER */}
            <div className="whop-main-container whop-desktop-force">
              {/* Profile Section */}
              <div className="whop-profile-section whop-profile-force">
              ...
              <div className="whop-levels-section whop-levels-force">
                {/* Left Column - Levels 1-5 */}
                <div className="whop-levels-left">
                ...
                <div className="whop-levels-right">
                  <div className="space-y-3">
