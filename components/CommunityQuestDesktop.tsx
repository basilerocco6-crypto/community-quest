...
export default function CommunityQuestDesktop() {
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="text-center">
                    <div className="text-sm lg:text-base xl:text-lg text-foreground">Community Member</div>
                    <div className="text-sm lg:text-base xl:text-lg" style={{color: '#2563EB'}}>Level {MOCK_USER.currentLevel}</div>
                    <div className="text-xs lg:text-sm text-muted-foreground">{((MOCK_LEVELS.find(l => l.level === MOCK_USER.totalPoints + 1)?.requiredPoints || MOCK_USER.totalPoints) - MOCK_USER.totalPoints)} points to level up</div>
                  </div>
                </div>
              </div>

              {/* Level Breakdown Section - Fixed Width */}
              <div 
